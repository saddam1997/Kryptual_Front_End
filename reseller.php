...
<body class="about-us">
    ...
    <div class="wrapper">
        <div class="page-header page-header-small">
            <div class="page-header-image" data-parallax="true" style="background-image: url('assets/img/sl99.jpg'); opacity: 0.5;">
            </div>
        ...
        <div class="section">
            <div class="about-description text-center" style="padding-top: 0px;">
                <div class="features-3" style="margin-top: -100px;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 mr-auto ml-auto">
                                <h2 class="title">Simpler. Smarter. Faster.</h2>
                                <h4 class="description">Invest only in ICOs you know and trust. Direct marketplace for all ICOs ever published.Find the right ICO to invest in quickly and easily.</h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                        <div class="col-md-4 ml-auto mr-auto text-center" style="margin-top: -65px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 ml-auto mr-auto">
                            <div class="card card-contact card-raised">
                                <form role="form" id="contact-form" method="post" action="apis/apis.php">
